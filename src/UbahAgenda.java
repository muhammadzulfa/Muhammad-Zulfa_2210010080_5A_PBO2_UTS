...
public class UbahAgenda extends javax.swing.JDialog {
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusActionPerformed
        ...
        if (confirm == JOptionPane.YES_OPTION) {
            // Panggil metode hapusAgenda di Dashboard untuk menghapus agenda berdasarkan indeks
            ((Dashboard) getParent()).hapusAgenda(agendaIndex);

            // Tutup form setelah penghapusan
            this.dispose();
        }
